...
Your task is to:
1. Review ALL vocabulary items from each model.
2. Remove any duplicated or overly simple/common words (especially those already learned).
3. Select ONLY THE MOST IMPORTANT AND CHALLENGING vocabulary item for focused learning.
4. Prioritize: unknown words > complex phrases > advanced vocabulary > simple words.
5. Ensure the selected item includes:
   - a word or phrase
...
Only return the single selected vocabulary item in the following JSON format:
{
  "phrases": [
    {
      "word": "word or phrase",
